...
\title{3MT - The history written in our DNA}
...
\begin{center}
{\tt
\ldots GTAACCGATAAGA\Cvermillion{G}ATTGCCCAAAACACAGACATGG\Cvermillion{A}AATAGCGTA\ldots \\
\ldots GTAACCGATAAGA\Cskyblue{T}ATTGCCCAAAACACAGACATGG\Cvermillion{A}AATAGCGTA\ldots \\
\ldots GTAACCGATAAGA\Cskyblue{T}ATTGCCCAAAACACAGACATGG\Cskyblue{T}AATAGCGTA\ldots \\
\ldots GTAACCGATAAGA\Cvermillion{G}ATTGCCCAAAACACAGACATGG\Cskyblue{T}AATAGCGTA\ldots \\
}
\vspace{10mm}
\includegraphics[scale=.35]{tree-seq-person.png}
\end{center}
\vspace{5mm}
